/**
 * Emblème officiel Lemnos (l'enclume), extrait du logo vectoriel fourni
 * (public/images/logo/LEMNOS.svg). Rendu en `currentColor` pour se recolorer
 * selon le contexte (vert sur clair, blanc sur sombre).
 */
const PATHS = [
